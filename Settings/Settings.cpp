...
namespace Settings
{
	void LoadSettings( string szIniFile )
	{
		...
		Aimbot::aim_Psilent = CSX::Cvar::LoadCvar(AIMBOT_TEXT, CVAR_AIMBOT_ANTIJUMP, Aimbot::aim_Psilent);
	...
	void SaveSettings( string szIniFile )
	{
		...
		CSX::Cvar::SaveCvar(AIMBOT_TEXT, CVAR_AIMBOT_ANTIJUMP, Aimbot::aim_Psilent);
